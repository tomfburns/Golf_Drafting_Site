    (() => {
      ...
      const API_BASE_URL = window.__API_BASE__ || 'https://golf-drafting-site.onrender.com/api';
      const SOCKET_URL = window.__SOCKET_BASE__ || 'https://golf-drafting-site.onrender.com';
